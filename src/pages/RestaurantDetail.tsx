      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              {restaurant.earlyBirdOffers &&
                restaurant.earlyBirdOffers.length > 0 && (
                    ...
                    {restaurant.earlyBirdOffers.map((offer) => (
                      <div key={offer.id}>
                        ...
                        <p className="text-sm text-gray-600">
                          Available: {offer.availableTimes}
                        </p>
                      </div>
                    ))}
                  </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-8">
                  Select a date and time to check availability. Early bird and
                  last-minute specials may offer different pricing.
                </p>
              </div>
